            ...
            {expandedItem === items && (
              <Div sx={{ background: alpha, borderBottom: `3px solid #37CF1E` }}>
                ...
                >
                  ...
                  <Div sx={{ pt: 2, mr: 1, display: "flex", flexDirection: "column" ,gap:2}}>
                    <Link to={ROUTE_PATH.FIRST_JUDGE_EVENT}>
                      <AppButton sx={{ background: "#DBDE27" }}>Judge</AppButton>
                    </Link>
                    <Link to={ROUTE_PATH.FIRST_JUDGE_EVENT}>
